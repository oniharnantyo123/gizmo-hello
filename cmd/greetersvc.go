...
import (
	...
	"github.com/oniharnantyo123/gizmo-hello/pkg/greeterendpoint"
	"github.com/oniharnantyo123/gizmo-hello/pkg/greetersd"
	"github.com/oniharnantyo123/gizmo-hello/pkg/greeterservice"
	"github.com/oniharnantyo123/gizmo-hello/pkg/greetertransport"
	"os"
	"os/signal"
	"strconv"
	"syscall"
...
func main() {
	...
	var (
		configPath = fs.String("config.path", "./cmd/config.json", "Config file path")
